...
<div class="p-6" x-data="izlenceTab()" x-init="yukle()" @tahsilat-dashboard-yenile.window="yukle()">
    ...
    <div x-show="!yukleniyor" class="space-y-5">
        ...
        <div x-show="beklentiDetayModal.acik"
             ...
             x-cloak>
            <div class="fixed inset-0 bg-slate-950/65 backdrop-blur-sm" @click="beklentiDetayModalKapat()"></div>
            <div class="relative flex min-h-screen items-center justify-center p-4 sm:p-6">
                <div class="relative w-full max-w-6xl max-h-[calc(100vh-2rem)] overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl dark:border-gray-700 dark:bg-gray-800 sm:max-h-[calc(100vh-3rem)]" @click.stop>
                    <div class="sticky top-0 z-10 flex items-center justify-between gap-3 border-b border-gray-200 bg-white px-5 py-4 dark:border-gray-700 dark:bg-gray-800">
                        <div>
