<div x-data="topluTahsilatModal()"
     x-show="acik"
     x-cloak
     @tahsilat-toplu-modal-ac.window="acik = true; reset()"
    ...
    <div class="relative min-h-screen flex items-center justify-center p-4">
        <div class="relative w-full max-w-2xl bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="px-5 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Toplu Tahsilat Ekle</h3>
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                        Bu veriler sadece İzlence analizine dahil edilir, tüm tahsilat listesine eklenmez.
                    </p>
                </div>
            ...
            <div class="p-5 space-y-4">
                <div class="rounded-xl border border-blue-200 dark:border-blue-800 bg-blue-50/70 dark:bg-blue-900/20 p-3">
                    <div class="text-sm font-medium text-blue-800 dark:text-blue-300">1. Excel Şablonunu İndir</div>
                    <div class="text-xs text-blue-700/90 dark:text-blue-300/90 mt-1">
                        Zorunlu sütunlar: <strong>Tahsilat Tarihi</strong>, <strong>Tutar</strong>, <strong>Müvekkil/Unvan</strong>
                    </div>
                ...
                <template x-if="sonuc">
                    <div class="rounded-lg border border-emerald-200 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-900/20 p-3">
                        ...
                        <div class="mt-1 text-xs text-emerald-700/90 dark:text-emerald-300/90">
                            ...
                            Güncellenen: <strong x-text="sonuc.updated ?? 0"></strong> |
            ...
            <div class="px-5 py-4 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-2">
                ...
                <button @click="importEt()"
                    ...
                    <span x-show="!yukleniyor">Toplu Tahsilat Ekle</span>
...
function topluTahsilatModal() {
    return {
        ...
        sablonIndir() {
            window.location.href = '/tahsilat/izlence-gecmis/sablon';
        },
        ...
        async importEt() {
            ...
            try {
                ...
                const res = await fetch('/tahsilat/izlence-gecmis/import', {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': token,
